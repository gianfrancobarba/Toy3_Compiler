...
printf("%s%c", stampa(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat("i risultati delle 4 operazioni sono \n", to_string((double[]){res1}, "double"))), "\n")), to_string((double[]){res2}, "double"))), "\n")), to_string((double[]){res3}, "double"))), "\n")), to_string((double[]){res4}, "double"))), "\n"))) , '\n');
}
