...
stampa(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat("la somma di ", strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(to_string((double[]){a},"double"), strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(" e ", strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(to_string((double[]){b},"double"), strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(" incrementata di ", strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(to_string((int[]){c},"int"), strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat(" è ", taglia)))))))))))))));
stampa(strcpy(arrayConcat[(currentIndex++)%MAX_CONCAT_SIZE], safe_strcat("ed è pari a ", to_string((double[]){risultato}, "double"))));
